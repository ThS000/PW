...
function getDashboardStats() {
    ...
    function totalGpus (index){
    return gpus [index].trasnsactions.filter(value => value > 0 )
    }
    console.log(totalGpus); // Acho eu que era para contar quantas gpus tem no total;
